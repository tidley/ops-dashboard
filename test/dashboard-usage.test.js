...
describe('dashboard usage stats', function() {
  ...
  it('aggregates usage by project and time bucket', function() {
    ...
    assert.equal(usage.aggregate24hSeries[2], 120);
    assert.equal(usage.aggregate24hSeries[8], 45);
    assert.equal(usage.aggregate24hSeries[15], 90);
    assert.equal(usage.aggregate7dSeries.length, 7);
    assert.equal(usage.aggregate24hSeries.length, 16);
    ...
    assert.equal(usage.aggregate24hSeries[16], undefined);
